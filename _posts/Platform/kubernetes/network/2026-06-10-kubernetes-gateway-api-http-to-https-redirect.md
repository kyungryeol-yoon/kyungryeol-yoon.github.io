...
> **이 시리즈는** 쿠버네티스 gRPC 삽질에서 출발해 HTTP/2·TLS·로드밸런서·Gateway API·인증서까지 풀어가는 기록입니다. 앞선 [Ingress → Gateway API 편](/posts/kubernetes-ingress-to-gateway-api-httproute/)과 [cert-manager TLS 편](/posts/kubernetes-cert-manager-pki-tls/)을 먼저 보면 이해가 빠릅니다.
