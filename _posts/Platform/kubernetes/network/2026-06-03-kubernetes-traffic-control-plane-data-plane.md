...
> **이 시리즈는** 쿠버네티스 gRPC 삽질에서 출발해 HTTP/2·TLS·로드밸런서·Gateway API·인증서까지 풀어가는 기록입니다. 이번 4편은 **쿠버네티스 트래픽 구조** 편입니다. 앞선 [1편(문제와 해결)](/posts/kubernetes-grpc-dotnet-http2-tls-troubleshooting/), [2편(h2 vs h2c)](/posts/kubernetes-grpc-http2-vs-h2c-tls/), [3편(L4 vs L7)](/posts/kubernetes-grpc-l4-l7-load-balancing/)을 먼저 보면 좋습니다.
...
- [관련 글: L4 vs L7 로드밸런서 (3편)](/posts/kubernetes-grpc-l4-l7-load-balancing/) · [HTTP/2는 TLS가 아니다 (2편)](/posts/kubernetes-grpc-http2-vs-h2c-tls/)
</content>
