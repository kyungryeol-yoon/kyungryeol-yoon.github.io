...
> **이 시리즈는** 쿠버네티스 gRPC 삽질에서 출발해 HTTP/2·TLS·로드밸런서·Gateway API·인증서까지 풀어가는 기록입니다. 이번 6편은 **인증서와 cert-manager** 편입니다. 앞선 [2편(h2 vs h2c)](/posts/kubernetes-grpc-http2-vs-h2c-tls/), [5편(Gateway API)](/posts/kubernetes-ingress-to-gateway-api-httproute/)을 먼저 보면 좋습니다.
...
- [관련 글: Gateway API (5편)](/posts/kubernetes-ingress-to-gateway-api-httproute/) · [h2 vs h2c (2편)](/posts/kubernetes-grpc-http2-vs-h2c-tls/)
</content>
