...
쿠버네티스를 공부하면서 가장 벽에 부딪히기 쉬운 부분이 바로 **네트워킹**입니다. 쿠버네티스는 우리가 기존에 알던 도커(Docker)의 네트워킹 방식과는 조금 다른 철학을 가지고 있기 때문인데요. 💡

오늘은 CoffeeWhale님의 기술 블로그 내용을 바탕으로, 쿠버네티스 네트워킹의 첫 단추인 **Pod 네트워킹**에 대해 깊이 있게 알아보겠습니다.
