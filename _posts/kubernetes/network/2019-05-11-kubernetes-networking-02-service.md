...
지난 포스팅에서 Pod끼리 통신하는 원리를 알아봤습니다. 하지만 큰 문제가 하나 있습니다. 바로 **Pod은 언제든 죽고 다시 살아날 수 있으며, 그때마다 IP가 변한다**는 점입니다. 😅

이렇게 변하는 Pod들을 하나의 고정된 주소로 묶어주는 존재가 바로 **Service**입니다. 오늘은 서비스가 어떻게 가상 IP를 유지하고 트래픽을 전달하는지 그 내부 원리를 파헤쳐 보겠습니다.
