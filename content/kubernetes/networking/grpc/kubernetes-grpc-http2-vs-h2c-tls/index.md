...
> **이 시리즈는** 쿠버네티스에 gRPC 서비스를 올리다 막힌 삽질에서 출발해 HTTP/2·TLS·로드밸런서·Gateway API·인증서까지 풀어가는 기록입니다. 이번 2편은 **기초 개념(h2 vs h2c)** 편입니다. 1편을 아직 안 읽었다면 [.NET gRPC가 게이트웨이 뒤에서 안 됐던 문제와 해결](/kubernetes/networking/grpc/kubernetes-grpc-dotnet-http2-tls-troubleshooting/)을 먼저 보면 좋습니다.
...
- [관련 글: gRPC가 .NET에서만 안 됐다 (시리즈 1편)](/kubernetes/networking/grpc/kubernetes-grpc-dotnet-http2-tls-troubleshooting/)
</content>
