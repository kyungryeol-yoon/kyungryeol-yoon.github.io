...
> **이 시리즈는** 쿠버네티스 gRPC 삽질에서 출발해 HTTP/2·TLS·로드밸런서·Gateway API·인증서까지 풀어가는 기록입니다. 이번 5편은 **Ingress → Gateway API** 편입니다. 앞선 [3편(L4 vs L7)](/kubernetes/networking/kubernetes-grpc-l4-l7-load-balancing/), [4편(트래픽 구조)](/kubernetes/networking/kubernetes-traffic-control-plane-data-plane/)을 먼저 보면 좋습니다.
...
- [관련 글: 트래픽 구조 (4편)](/kubernetes/networking/kubernetes-traffic-control-plane-data-plane/) · [L4 vs L7 (3편)](/kubernetes/networking/kubernetes-grpc-l4-l7-load-balancing/)
</content>
