---
title: "[Kubernetes] Upgrade Kubernetes(v1.29.x) using Kubekey(v3.0.13) Artifact"
date: 2024-03-05
tags: [kubernetes, kubekey, artifact, upgrade]
description: "KubeKey(v3.0.13) artifact로 쿠버네티스를 v1.29.x로 오프라인 업그레이드하는 방법. artifact 구성과 버전 호환, 업그레이드 절차를 정리합니다."
---
